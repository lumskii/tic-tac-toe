...
//Drawing the Board using a forEach function
const drawBoard = () => {
    boxes.forEach((box, i) => {
        let styleString = '';
        if (i < 3) {
...
//Defining variable for the O's and X's
const spaces = [];
const tick_circle = 'O';
const tick_x = 'X';
let currentPlayer = tick_circle;

//The boxClicked function taking the click event as an argument
const boxClicked = (e) => {
